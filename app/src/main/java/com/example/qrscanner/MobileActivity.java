...
public class MobileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentActivity.setImageResource(R.drawable.mobile_phone_2635);
            ...
            public void onClick(View v) {
                if (dbHelper != null) {
                    if (!filteredList.isEmpty()) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(MobileActivity.this, R.style.AlertDialogTheme);
                        View view = LayoutInflater.from(MobileActivity.this).inflate(R.layout.layout_delete_dialog, (ConstraintLayout) findViewById(R.id.layoutDialogContainer));
                        builder.setView(view);
                        ((TextView) view.findViewById(R.id.titleText)).setText("Delete [ All Mobile Phones ]");
                        ((TextView) view.findViewById(R.id.messageText)).setText("Do you want to [ All Mobile Phones ] ?" + "\n" + "\n" + "This action cannot be undone.");
                        ...
                        view.findViewById(R.id.actionDelete).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                deviceList.clear();
                                Toast.makeText(MobileActivity.this, "All Phones Deleted", Toast.LENGTH_SHORT).show();
                                alertDialog.hide();
                        ...
                        view.findViewById(R.id.actionCancel).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(MobileActivity.this, "Canceled", Toast.LENGTH_SHORT).show();
                                alertDialog.hide();
                            }
                        });
    ...
    private void deleteDataByGadgetName() {
        ...
        while (iterator.hasNext()) {
            ...
            if (device.getDevice().equalsIgnoreCase("Phone")) {
    ...
    // Show the item that has a "Phone" in the Device column
