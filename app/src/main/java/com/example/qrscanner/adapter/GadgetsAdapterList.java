...
public class GadgetsAdapterList extends BaseAdapter {

    private Context context;
    private List<GadgetsList> gadgets;

    public GadgetsAdapterList(Context context, List<GadgetsList> gadgets) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GadgetsList gadget = gadgets.get(position);
...
//            ivGadgetImage.setImageResource(R.drawable.device_model); // Use a default image if no image is provided
    ...
    public List<GadgetsList> getGadgetsList() {
        return gadgets;
    }
}