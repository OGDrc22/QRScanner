...
public class UnknownDeviceActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (dbHelper != null) {
                    if (!filteredList.isEmpty()) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(UnknownDeviceActivity.this, R.style.AlertDialogTheme);
                        View view = LayoutInflater.from(UnknownDeviceActivity.this).inflate(R.layout.layout_delete_dialog, (ConstraintLayout) findViewById(R.id.layoutDialogContainer));
                        builder.setView(view);
                        ((TextView) view.findViewById(R.id.titleText)).setText("Delete [ All Unknown Device ]");
                        ((TextView) view.findViewById(R.id.messageText)).setText("Do you want to [ All unknown devices ] ?" + "\n" + "\n" + "This action cannot be undone.");
                        ...
                        view.findViewById(R.id.actionDelete).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                deviceList.clear();
                                Toast.makeText(UnknownDeviceActivity.this, "All Unknown Devices Deleted", Toast.LENGTH_SHORT).show();
                                alertDialog.hide();
                        ...
                        view.findViewById(R.id.actionCancel).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(UnknownDeviceActivity.this, "Canceled", Toast.LENGTH_SHORT).show();
                                alertDialog.hide();
                            }
                        });
    ...
    private void deleteDataByGadgetName() {
        ...
        while (iterator.hasNext()) {
            ...
            if (device.getDevice().equalsIgnoreCase("Unknown")) {
