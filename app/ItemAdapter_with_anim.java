...
//                    editClickListener.onEditClick(position);
        ...
        if (data.isSelected()) {
            ...
            viewHolder.cardViewMain.setStrokeWidth(6);
        } else {
...
//                        Log.d(TAG, "Expand: Before Setting Text Sizes: serialNum_tv TextSZ " + serialNum_tv.getTextSize());
                serialNum_tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize_for_textHolderAssigned);
//                        Log.d(TAG, "Expand: After Setting Text Sizes: serialNum_tv TextSZ " + serialNum_tv.getTextSize());
...
//            imgScan.setLayoutParams(params);
    ...
    public void updateSelectionCount() {
        ...
        if (context instanceof Activity) {
            ...
            TextView textView = activity.findViewById(R.id.textViewCountselection);
...
//                cardViewMain.setStrokeColor(ContextCompat.getColor(context, R.color.divider));
//                cardViewMain.setStrokeWidth(2);
    ...
    public void deleteSelectedItem() {
        DeleteSelected deleteSelected = new DeleteSelected(context, this, main);
